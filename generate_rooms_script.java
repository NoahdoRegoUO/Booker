...
public class generate_rooms_script {
    public static void main(String[] args){
        ...
        for(int i = 0; i < 220; i++){
            ...
            query = "INSERT INTO room(roomnumber, price, occupied, amenities, extendable, view, issues, capacity, hotelid) VALUES ("+roomnumber+", "+price+", false, "+amenities+", "+extendable+", "+view+", "+issues+", "+capacity+", "+hotelid+");";
